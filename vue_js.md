Для создания проекта необходимо ввести команду npm init vue@latest, после перейти в папку проекта и ввести команду npm install, если это был первый запуск, а после ввести команду npm run dev
